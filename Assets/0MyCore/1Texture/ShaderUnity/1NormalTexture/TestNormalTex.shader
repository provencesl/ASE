    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.normal = normalize(float3(dot(o.TtoW0.xyz, o.normal), 
                                        dot(o.TtoW1.xyz, o.normal),
                                        dot(o.TtoW2.xyz, o.normal)));

                //o.normal = worldNormal;    
                //确实可以在顶点着色器里对法线贴图进行采样但是结果不细致。    
